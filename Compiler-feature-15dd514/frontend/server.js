...
app.get("/api/dashboard/stats", async (req, res) => {
  try {
    ...
    console.log("Progress calculation:", {
      ...
      total: total,
      successfulStates: stats.syncStatus.perfectMatch + stats.syncStatus.listeningChanges + stats.syncStatus.noData,
...
app.get("/api/logs", async (req, res) => {
  try {
    const { lines = 100, level = "ALL", function: functionFilter = "ALL" } = req.query;
