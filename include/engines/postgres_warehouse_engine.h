#ifndef POSTGRES_WAREHOUSE_ENGINE_H
#define POSTGRES_WAREHOUSE_ENGINE_H
...
class PostgresWarehouseEngine : public IWarehouseEngine {
  std::string connectionString_;

public:
  explicit PostgresWarehouseEngine(std::string connectionString);
